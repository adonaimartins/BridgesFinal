                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav mr-auto">
                                <li><a style="color: grey; margin-right: 20px" href="{{ URL::to('angles') }}">View All Angles</a></li>
                                <li><a style="color: grey" href="{{ URL::to(route('angles.create')) }}">Create an Angle</a>
                            </ul>
