                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav mr-auto">
                                <li><a style="color: grey; margin-right: 20px"  href="{{ URL::to('girders') }}">View All girders</a></li>
                                <li><a style="color: grey"  href="{{ URL::to(route('girders.create')) }}">Create a girder</a>
                            </ul>
